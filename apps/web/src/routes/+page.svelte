...
<div class="min-h-screen bg-brand-black text-brand-white selection:bg-brand-purple selection:text-white">
  ...
  <!-- Hero -->
  <section class="max-w-7xl mx-auto px-6 py-24 md:py-32 relative overflow-hidden">
    <!-- Background Gradient Blob -->
    <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-purple/20 rounded-full blur-[120px] -z-10 animate-pulse"></div>
    
    <div class="max-w-4xl">
      <div class="inline-flex items-center gap-2 px-3 py-1 bg-brand-white/5 border border-brand-white/10 rounded-full text-brand-white/80 text-sm mb-6 font-mono backdrop-blur-sm">
  ...
  <!-- Three Pillars -->
  <section class="border-t border-brand-white/10 py-24 bg-brand-black/50">
    <div class="max-w-7xl mx-auto px-6">
      <h2 class="text-3xl font-bold font-display mb-16 flex items-center gap-4">
        <span class="w-8 h-1 bg-brand-purple rounded-full"></span>
        Why FairHire?
      </h2>
      <div class="grid md:grid-cols-3 gap-8">
        <!-- Pillar 1 -->
        <div class="p-8 bg-brand-white/5 rounded-xl border border-brand-white/5 hover:border-brand-purple/50 transition-colors group">
  ...
  <!-- Tier System -->
  <section class="border-t border-brand-white/10 py-24 relative">
    <div class="absolute inset-0 bg-gradient-to-b from-brand-black to-brand-purple/5 opacity-50"></div>
    <div class="max-w-7xl mx-auto px-6 relative z-10">
      <div class="text-center mb-16">
        <h2 class="text-3xl font-bold font-display mb-4">Reputation Tiers</h2>
        <p class="text-brand-white/60 max-w-xl mx-auto">Your FairScore determines your payment terms. Higher score = faster money.</p>
      </div>
      <div class="grid md:grid-cols-3 gap-6">
        <!-- Alpha -->
        <div class="p-8 bg-gradient-to-br from-brand-white/5 to-brand-white/0 rounded-xl border border-brand-white/10 hover:border-brand-white/20 transition-all shadow-2xl relative overflow-hidden group">
        ...
        <!-- Trusted -->
        <div class="p-8 bg-brand-white/5 rounded-xl border border-brand-white/10 hover:border-brand-white/20 transition-all">
  ...
  <!-- CTA -->
  <section class="border-t border-brand-white/10 py-24 bg-brand-white/5">
    <div class="max-w-3xl mx-auto px-6 text-center">
      <h2 class="text-4xl font-bold mb-6 font-display">Ready to earn on your terms?</h2>
      <p class="text-xl text-brand-white/60 mb-10">Connect your wallet and start building your on-chain reputation today.</p>
      <a href="/app/tasks" class="inline-flex px-8 py-4 bg-brand-white text-brand-black rounded-lg font-bold text-lg hover:bg-brand-white/90 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1">
        Launch FairHire
      </a>
    </div>
  </section>
  ...
  <!-- Footer -->
  <footer class="border-t border-brand-white/10 py-12 bg-brand-black">
